function HTML5_UDP_SOCKET_POLYFILL(self, vendor) {
    ...
    function UDPPermission() {
         if (arguments[0] !== self.navigator) {
             if (this instanceof UDPPermission) {
                 throw new TypeError('The UDPPermission interface should not be called as constructor');
             } else {
                 throw new TypeError('The UDPPermission interface should not be called as function');
             }
         }
     }

    Object.defineProperty(UDPPermission, 'prototype', {
        writable: false,
        ...
        // @see https://www.w3.org/TR/WebIDL/#interface-prototype-object
        value: new function UDPPermissionPrototype() {
            ...
            */
            ...
            this.hasPermission = function () {
                ...
                udpPermissionOptions = arguments[0];
                ...
                udpPermissionPromise = new Promise(function (resolve, reject) {
                    ...
                    if (typeError) {
                        reject(new TypeError('udpPermissionOptions must be an object'));
                    }
    ...
    function UDPSocket() {
        ...
        udpOptions = arguments[0];
        mySocket = this;
        step1 = vendor.createUdpSocket(udpOptions);
        ...
        step3 = step1.then(function () {
            ...
            if (udpOptions.remoteAddress) {
                ...
                if (isValidAddress(udpOptions.remoteAddress)) {
                    ...
                    throw InvalidAccessError('Invalid Remote Address:' + udpOptions.remoteAddress);
                }
            } else {
        ...
        step5 = step4.then(function () {
            ...
            if (udpOptions.localAddress) {
                if (udpOptions.remoteAddress) {
                    ...
                    if (vendor.isValidAddressCombination(udpOptions.localAddress, udpOptions.remoteAddress)) {
                        // bind the socket to this local IPv4/6 address and set the mySocket.localAddress attribute to this address.
                        return vendorDatagramSocket.bind(udpOptions.localAddress).then(function () {
                            defineReadOnlyProperty('localAddress', udpOptions.localAddress);
                        });
                    } else {
                        ...
                        throw InvalidAccessError('Invalid Local Address:' + udpOptions.localAddress);
                    }
                } else {
                    ...
                    // If the options argument's localAddress member is a valid IPv4/6 address for a local interface
                    // on the device
                    if (vendor.isValidLocalAddress(udpOptions.localAddress)) {
                ...
                if (udpOptions.remoteAddress) {
                    ...
                    return vendorDatagramSocket.getLocaleInterface(
                        ...
                        // throw DOMException InvalidAccessError and abort the remaining steps.
                        throw InvalidAccessError('Invalid Local Address:' + udpOptions.remoteAddress);
                    });
                } else {
        ...
        step7 = step6.then(function () {
            ...
            if (udpOptions.hasOwnProperty('addressReuse')) {
                defineReadOnlyProperty('addressReuse', udpOptions.addressReuse);
            } else {
        ...
        step8 = step7.then(function () {
            ...
            if (udpOptions.hasOwnProperty('loopback')) {
                // then set the mySocket.loopback attribute to the value of this field.
                defineReadOnlyProperty('loopback', udpOptions.loopback);
            } else {
    ...
    Object.defineProperty(UDPSocket, 'prototype', {
        writable: false,
        // The class string of an interface prototype object is the concatenation of the interface’s identifier and the string “Prototype”.
        // @see https://www.w3.org/TR/WebIDL/#interface-prototype-object
        value: new function UDPSocketPrototype() {

            var _self = this;

            function getter() {
                // if (this === _self) {
                    throw TypeError(name + ' is only accessible from the instance');
                // }
                // return udpPermission;
            }
           ...
           [
               ...
               'addressReuse', 'loopback',
               'readyState', 'opened', 'closed',
               'readable', 'writable'
            ...
            */
           this.joinMulticast = function (multicastGroupAddress) {
               if (!this || !(this instanceof UDPSocket)) {
                   throw new TypeError('the context must be UDPSocket instance');
               }
               if (typeof multicastGroupAddress !== 'string') {
                   throw new TypeError('the "multicastGroupAddress" parameter must be a string');
               }
               // TODO: Get access to vendorDatagramSocket
            ...
            * @param {string} multicastGroupAddress The multicast group address.
            */
           this.leaveMulticast = function (multicastGroupAddress) {
               if (!this || !(this instanceof UDPSocket)) {
                   throw new TypeError('the context must be UDPSocket instance');
               }
               if (typeof multicastGroupAddress !== 'string') {
    ...
    udpPermission = new UDPPermission(self.navigator);

    Object.defineProperty(Navigator.prototype, 'udpPermission', {
        enumerable: true,
        configurable: true,
        get: function () {
            if (this !== self.navigator) {
                throw TypeError('udpPermission is only accessible from the navigator object');
            }
            return udpPermission;
        }
    });

    Object.defineProperty(self, 'UDPPermission', {
        enumerable: false,
        writable: true,
        configurable: true,
        value: UDPPermission
    ...
    Object.defineProperty(self, 'UDPSocket', {
       enumerable: false,
       writable: true,
       configurable: true,
       value: UDPSocket
